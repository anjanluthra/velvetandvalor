---
title: "What Is MagSafe? Everything Explained"
description: "<What is MagSafe? Learn how Apple's magnetic charging system works, which iPhones support it, and what to look for in a MagSafe case.>"
excerpt: "MagSafe is Apple's ring of built-in magnets that snaps accessories and chargers precisely into place on your iPhone. Here's everything you need to know, from how it works to choosing the right case."
category: iphone-case-guides
tags: ["iphone cases", "magsafe", "iphone accessories", "case buying guide", "product education"]
author: kate-luthra
date: 2026-06-25
featured: false
keyTakeaways:
  - "MagSafe is a ring of 18 magnets built into iPhone 12 and later models that enables precise magnetic alignment for charging and accessories."
  - "A MagSafe case must be made from materials thin enough and magnetically transparent enough to allow the magnetic field to reach through — full-grain leather, when cut to the correct thickness, passes this requirement."
  - "MagSafe charging delivers up to 15 W through a certified MagSafe charger, compared with up to 7.5 W for standard Qi wireless charging on iPhone."
  - "Not all cases labelled \"magnetic\" are true MagSafe cases — look for Apple's \"Made for MagSafe\" certification or a manufacturer's explicit compatibility statement."
faq:
  - q: "Does MagSafe work through any case?"
    a: "MagSafe charges and attaches through most slim, non-metallic cases. Very thick cases (generally over 5 mm), cases with metal plates or magnetic clasps, and cases with built-in card slots sitting behind the coil area can all reduce charging speed or block attachment entirely. Always check your case manufacturer's compatibility statement."
  - q: "Will MagSafe damage my credit cards or hotel key cards?"
    a: "Apple advises keeping credit cards, security badges, passports, and key fobs away from the MagSafe area of your iPhone, as the magnets and NFC reader can demagnetise or interfere with those items. Store cards in a separate wallet or in a case designed with the card slot positioned away from the magnetic ring."
  - q: "Is MagSafe the same as Qi wireless charging?"
    a: "No, though they share the same underlying inductive charging principle. Standard Qi charges iPhone at up to 7.5 W and requires only rough alignment. MagSafe uses a precisely aligned magnetic ring to deliver up to 15 W — twice the speed — and also enables a broader ecosystem of snap-on accessories beyond charging alone."
  - q: "Which iPhones support MagSafe?"
    a: "Every iPhone from the iPhone 12 onwards supports MagSafe, including the mini, Plus, Pro, and Pro Max variants of each generation. Earlier iPhones support standard Qi wireless charging but lack the internal magnet array required for MagSafe accessories."
  - q: "Can I use a MagSafe charger on an older iPhone?"
    a: "You can hold a MagSafe charger against an older Qi-compatible iPhone (iPhone 8 and later) and it will charge wirelessly, but only at standard Qi speeds (up to 7.5 W) and without the magnetic snap — because those older models lack the internal magnet ring."
cover: "/images/blog/what-is-magsafe.webp"
coverAlt: "What Is MagSafe? Everything Explained — iPhone Case Guides · Velvet & Valor"
---
...
1. **Magnetic transparency** — the material and thickness of the case must allow the iPhone's magnets to exert sufficient force through the case wall to grip a MagSafe charger or accessory on the outside.
2. **No magnetic interference** — metal plates, magnetic clasps, or thick ferrous components inside the case can disrupt or deflect the magnetic field, reducing grip strength or blocking NFC communication entirely.
...
At Velvet & Valor, every hide is hand-skived (thinned at the edges and measured at the body) before construction to ensure the finished wall sits within the tolerance that keeps MagSafe performing as Apple intended. If you are browsing our [full collection of handcrafted iPhone cases](/collections/iphone-cases), you will find each listing specifies MagSafe compatibility explicitly — because for us, it is not an afterthought but a design constraint built into the pattern from the first cut.
...
- Check whether the manufacturer offers [custom or personalised options](/custom) — a monogrammed case or one tooled with an equestrian motif is not vanity; it is a marker of ownership that makes the object genuinely yours, in the same way a saddler would stamp a bridle with your initials.
...
**"MagSafe will erase my cards."**
The magnets can interfere with the magnetic stripe on traditional credit cards and hotel key cards if those cards are placed directly against the MagSafe area. They will not affect chip-and-PIN cards at a distance, and they will not affect the iPhone's own data. The practical solution is straightforward: keep cards in a separate wallet or choose a case design where the card slot sits *below* the magnetic ring, not behind it.

**"Any magnetic case is a MagSafe case."**
...
**"MagSafe damages the iPhone's internals."**
Apple designed the iPhone's internal components specifically to coexist with the MagSafe magnet array. The system has been in production since 2020 without documented evidence of magnet-related internal damage. Pacemaker and implanted cardiac device users, however, are advised by Apple to keep MagSafe devices at a safe distance — Apple's own guidance on this is available at [https://www.apple.com/uk/shop/product/MHXH3ZM/A](https://support.apple.com/en-gb/111876).

**"MagSafe is only useful for charging."**
As the ecosystem section above illustrates, charging is simply the most familiar use case. The mounting, wallet, and battery pack applications arguably offer more daily utility for many users — particularly those who spend time outdoors, in the stable yard, or travelling to competitions where a cable-free, one-hand-detachable phone mount is genuinely practical.
...
For more guidance on choosing and caring for leather iPhone cases, as well as broader buying advice across every iPhone model, visit [The Equestrian Journal](/blog) for further reading.
